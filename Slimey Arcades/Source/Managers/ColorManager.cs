...
namespace Slimey_Arcades
{
    ...
    {
        public static readonly Color GreenSlime = new Color(0, 200, 50);
        public static readonly Color RedSlime = new Color(250, 50, 50);
        public static readonly Color BlueSlime = new Color(50, 115, 230);
        public static readonly Color PinkSlime = new Color(240, 80, 240);
        public static readonly Color YellowSlime = new Color(240, 240, 80);
        public static readonly Color Ice = new Color(50, 225, 225);
        public static readonly Color Barrel = new Color(225, 100, 50);
        public static readonly Color Wall = new Color(0, 0, 0);
        public static readonly Color None = new Color(0, 0, 0, 0);
        public static readonly Color RedSwitch = new Color(255, 0, 0);
        public static readonly Color BlueSwitch = new Color(0, 0, 255);
        public static Color InvertColor(Color OldColor)
        {
            Color NewColor = new Color(255 - OldColor.R, 255 - OldColor.G, 255 - OldColor.B);
            NewColor.A = OldColor.A;
